c================    L-BFGS-B (version 2.1)   ==========================
      ...
      subroutine lbfgsb_setulb(n,m,x,l,u,nbd,f,g,factr,pgtol, 
     +                 wa,iwa,
...
c     ************
     ...
     +          lsgo,lwy,lsy,lss,lyy,lwt,lwn,lsnd,lygo
      ...
      call lbfgsb_mainlb(n,m,x,l,u,nbd,f,g,factr,pgtol,
...
c======================= The end of setulb =============================
      ...
      subroutine lbfgsb_mainlb(n,m,x,l,u,nbd,f,g,factr,pgtol, 
     +                  ws,wy,
...
c       subroutine lbfgsb_formk with this information.
c
c     task is a working string of characters of length 60 indicating
...
c     Subprograms called
c
c       L-BFGS-B Library ... cauchy, subsm, lnsrlb, lbfgsb_formk, 
c
...
c        Check the input arguments for errors.
      ...
      call lbfgsb_errclb(n,m,factr,l,u,nbd,task,info,k)
         if (task(1:5) .eq. 'ERROR') then
            call lbfgsb_prn3lb(n,x,f,task,iprint,info,itfile,
     ...
     +                  cachyt,sbtime,lnscht)
         ...
         call lbfgsb_prn1lb(n,m,l,u,x,iprint,itfile,epsmch)
 
c        Initialize iwhere & project x onto the feasible set.
 
        call lbfgsb_active(n,l,u,nbd,x,iwhere,iprint,prjctd,cnstnd,
     +                      boxed) 
...
c     Compute the infinity norm of the (-) projected gradient.
      ...
      call lbfgsb_projgr(n,l,u,nbd,x,g,sbgnrm)
...
cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      ...
      call lbfgsb_cauchy(n,x,l,u,nbd,g,indx2,iwhere,t,d,z,
...
c     find the index set of free and active variables at the GCP.
      ...
      call lbfgsb_freev(n,nfree,index,nenter,ileave,indx2,
...
c                     [ 0  I]
      ...
      if (wrk) call lbfgsb_formk(n,nfree,index,nenter,ileave,indx2,
     +                 iupdat,
...
c                                                   from 'cauchy').
      call lbfgsb_cmprlb(n,m,x,g,ws,wy,sy,wt,z,r,wa,index,
     +           theta,col,head,nfree,cnstnd,info)
      if (info .ne. 0) goto 444
c       call the direct method.
      call lbfgsb_subsm(n,m,nfree,index,l,u,nbd,z,r,ws,wy,theta,
...
c     Generate the search direction d:=z-x.
  ...
  40  continue
      call lbfgsb_timer(cpu1) 
 666  continue
      call lbfgsb_lnsrlb(n,l,u,nbd,x,f,fold,gd,gdold,g,d,r,t,z,stp,
     +            dnorm,
...
c        Print iteration information.
         ...
         call lbfgsb_prn2lb(n,x,f,g,iprint,itfile,iter,nfgv,nact,
...
C-xexo (skip factr test)
c      ddum = max(abs(fold), abs(f), one)
c      if ((fold - f) .le. tol*ddum) then
cc                                        terminate the algorithm.
c         task = 'CONVERGENCE: REL_REDUCTION_OF_F <= FACTR*EPSMCH'
...
c     Update matrices WS and WY and form the middle matrix in B.
      ...
      call lbfgsb_matupd(n,m,ws,wy,sy,ss,d,r,itail,
...
c           J' stored in the upper triangular of wt.
      ...
      call lbfgsb_formt(m,wt,sy,ss,col,theta,info)
...
c     Save local variables.
 ...
 1003 format (2(1x,i4),5x,'-',5x,'-',3x,'-',5x,'-',5x,'-',8x,'-',3x,
     +        1p,2(1x,d10.3))
 1004 format ('  ys=',1p,e10.3,'  -gs=',1p,e10.3,
     + ' BFGS update SKIPPED')
 1005 format (/, 
...
c======================= The end of mainlb =============================
      ...
      subroutine lbfgsb_active(n, l, u, nbd, x, iwhere, iprint,
     +                  prjctd, cnstnd, boxed)
...
c======================= The end of lbfgsb_active =============================
 
      subroutine lbfgsb_bmv(m, sy, wt, col, v, p, info)
...
c======================== The end of bmv ===============================
      ...
      subroutine lbfgsb_cauchy(n,x,l,u,nbd,g,iorder,iwhere,t, 
     +                  d,xcp, 
...
c     ************
     ...
     +                 tu,tl,wmc,wmp,wmw,lbfgsb_ddot,tj,tj0,neggi,
     +                 sbgnrm,
     +                 f2_org
      double precision one,zero
      parameter        (one=1.0d0,zero=0.0d0)
...
c     Initialize derivative f2.
      ...
      f2_org  =  f2
      if (col .gt. 0) then
     	 call lbfgsb_bmv(m,sy,wt,col,p,v,info)
      if (info .ne. 0) return
...
c           (if iter=2, initialize heap).
         ...
         call lbfgsb_hpsolb(nleft,t,iorder,iter-2)
         tj = t(nleft)
         ibp = iorder(nleft)  
      endif 
...
c           compute (wbp)Mc, (wbp)Mp, and (wbp)M(wbp)'.
         call lbfgsb_bmv(m,sy,wt,col,wbp,v,info)
      if (info .ne. 0) return
...
c       which will be used in computing r = Z'(B(x^c - x) + g).
 ...
 4010 format ('Piece    ',i3,' --f1, f2 at start point ',1p,
     + 2(1x,d11.4))
...
c====================== The end of cauchy ==============================
      ...
      subroutine lbfgsb_cmprlb(n, m, x, g, ws, wy, sy, wt, z, r, 
     +                 wa, index, 
     +                 theta, col, head, nfree, cnstnd, info)
...
c     ************
  ...
  30     continue
     	 call lbfgsb_bmv(m,sy,wt,col,wa(2*m+1),wa(1),info)
         if (info .ne. 0) then
            info = -8
        return
         endif
...
c======================= The end of cmprlb =============================
      ...
      subroutine lbfgsb_errclb(n, m, factr, l, u, nbd, task, info, k)
...
c======================= The end of errclb =============================
      ...
      subroutine lbfgsb_formk(n, nsub, ind, nenter, ileave, indx2, 
     +                 iupdat, 
...
c     Subprograms called:
c
c       Linpack ... lbfgsb_dcopy, dpofa, dtrsl.
c
c
c     References:
c       [1] R. H. Byrd, P. Lu, J. Nocedal and C. Zhu, ``A limited
...
c======================= The end of lbfgsb_formk ==============================

      subroutine lbfgsb_formt(m, wt, sy, ss, col, theta, info)
...
c======================= The end of formt ==============================
      ...
      subroutine lbfgsb_freev(n, nfree, index, nenter, ileave, indx2, 
     +                 iwhere, wrk, updatd, cnstnd, iprint, iter)
...
c======================= The end of freev ==============================
      ...
      subroutine lbfgsb_hpsolb(n, t, iorder, iheap)
...
c====================== The end of hpsolb ==============================
      ...
      subroutine lbfgsb_lnsrlb(n,l,u,nbd,x,f,fold,gd,gdold,g, 
     +                  d,r,t,
...
c                               Line search is impossible.
      ...
      call lbfgsb_dcsrch(f,gd,stp,ftol,gtol,xtol,zero,stpmx,csave,
     +           isave,dsave)
...
c======================= The end of lnsrlb =============================
      ...
      subroutine lbfgsb_matupd(n, m, ws, wy, sy, ss, d, r, itail, 
     +                  iupdat, col, head, theta, rr, dr, stp, dtd)
...
c======================= The end of matupd =============================
      ...
      subroutine lbfgsb_prn1lb(n, m, l, u, x, iprint, itfile, epsmch)
...
c     ************
 ...
 2001 format ('RUNNING THE L-BFGS-B CODE',/,/,
     + 'it   = iteration number',/,
     + 'nf   = num of function evaluations',/,
     + 'nint = num of segments explored during the Cauchy search',/,
     + 'nact = num of active bounds at the generalized Cauchy point'
     + ,/,
     + 'sub  = manner in which the subspace minimization terminated:'
     + ,/,'        con = converged, bnd = a bound was reached',/,
     + 'itls = num of iterations performed in the line search',/,
 ...
 7001 format ('RUNNING THE L-BFGS-B CODE',/,/,
     + '           * * *',/,/,
     + 'Machine precision =',1p,d10.3)
 9001 format (/,3x,'it',3x,'nf',2x,'nint',2x,'nact',2x,'sub',2x,
     +        'itls',
...
c======================= The end of prn1lb =============================
      ...
      subroutine lbfgsb_prn2lb(n, x, f, g, iprint, itfile, iter, 
     +                  nfgv, nact, 
     +                  sbgnrm, nint, word, iword, iback, stp, xstep)
...
c                             the truncated Newton step has been used.
 ...
 1004 format (/,a4, 1p, 6(1x,d11.4),/,(4x,1p,6(1x,d11.4)))
 2001 format
     +  (/,'At iterate',i5,4x,'f= ',1p,d12.5,4x,'|proj g|= ',
     +  1p,d12.5)
 3001 format(2(1x,i4),2(1x,i5),2x,a3,1x,i4,1p,2(2x,d7.1),1p,
     +  2(1x,d10.3))
...
c======================= The end of prn2lb =============================
      ...
      subroutine lbfgsb_prn3lb(n, x, f, task, iprint, info, itfile, 
     +                  iter, nfgv, nintol, nskip, nact, sbgnrm, 
     +                  time, nint, word, iback, stp, xstep, k, 
     +                  cachyt, sbtime, lnscht)
...
c     ************
 ...
 1004 format (/,a4, 1p, 6(1x,d11.4),/,(4x,1p,6(1x,d11.4)))
 3002 format(2(1x,i4),2(1x,i5),2x,a3,1x,i4,1p,2(2x,d7.1),
     + 6x,'-',10x,'-')
 3003 format (/,
     + '           * * *',/,/,
...
c======================= The end of prn3lb =============================
      ...
      subroutine lbfgsb_projgr(n, l, u, nbd, x, g, sbgnrm)
...
c======================= The end of projgr =============================
      ...
      subroutine lbfgsb_subsm(n, m, nsub, ind, l, u, nbd, x, d, ws, 
     +                 wy, theta, 
...
c====================== The end of subsm ===============================
      ...
      subroutine lbfgsb_dcsrch(f,g,stp,ftol,gtol,xtol,stpmin,stpmax,
     +                  task,isave,dsave)
      character*(*) task
      integer isave(2)
...
c        Call dcstep to update stx, sty, and to compute the new step.
         ...
         call lbfgsb_dcstep(stx,fxm,gxm,sty,fym,gym,stp,fm,gm,
     +               brackt,stmin,stmax)
...
c       Call dcstep to update stx, sty, and to compute the new step.
        ...
        call lbfgsb_dcstep(stx,fx,gx,sty,fy,gy,stp,f,g,
     +              brackt,stmin,stmax)
...
c====================== The end of dcsrch ==============================
      ...
      subroutine lbfgsb_dcstep(stx,fx,dx,sty,fy,dy,stp,fp,dp,brackt,
     +                  stpmin,stpmax)
      logical brackt
...
c====================== The end of lbfgsb_dnrm2 ===============================
      ...
      double precision function lbfgsb_dpmeps()
c     **********
c
c     Subroutine dpeps
c
...
c     determine dpmeps.
   ...
   60 continue
      ...
      a = (a*(one + a))/two
      temp = one + a
      if (temp - one .ne. zero) lbfgsb_dpmeps = a
