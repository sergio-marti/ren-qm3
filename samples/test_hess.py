...
tmp = numpy.trace( hes )
print( tmp )
assert( numpy.fabs( tmp - 273925.98919048626 ) < 1.e-4 ), "Hessian calculation error"
...
tmp = qm3.utils.hessian.RT_modes( mol )[-1].sum()
print( tmp )
...
print( tmp )
assert( numpy.fabs( tmp - 463.87564142413726 ) < 0.01 ), "IR intensities error"
...
print( tmp )
assert( numpy.fabs( tmp - 39.6409782741856 ) < 1.e-4 ), "Reduced masses error"
