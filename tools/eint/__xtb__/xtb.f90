...
subroutine qm3_xtb_calc( nQM, nMM, siz, mxit, dat )
    use qm3
    implicit none
    ...
    if( nMM > 0 ) then
        ...
        !pcem%gam = 99.0d0     ! https://xtb-docs.readthedocs.io/en/latest/pcem.html
        pcem%gam = 0.461493d0 ! pcem_dummyatom = 7
        do i = 1, nMM
